...
<head>
    ...
    <style>
        ...
        /* SIDEBAR - DISAMAKAN */
        .sidebar { width: 280px; background: #111; color: white; padding: 40px 24px; position: fixed; height: 100vh; z-index: 1000; }
        ...
        .form-control, .form-select { border-radius: 12px; padding: 12px; border: 1px solid #eee; margin-top: 8px; }
...
<div class="main-content">
    <div class="text-center mb-4">
        ...
        <p class="text-muted">Daftarkan akun admin atau siswa baru</p>
    </div>
    ...
    <div class="form-card">
        <form action="proses_tambah_user.php" method="POST">
            ...
            <button type="submit" class="btn btn-dark w-100 py-3 fw-bold mb-3" style="border-radius: 12px;">Simpan User</button>
